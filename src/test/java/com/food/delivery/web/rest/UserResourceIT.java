...
import com.food.delivery.service.mapper.UserMapper;
...
class UserResourceIT {
     ...
     */
    public static UserModel initTestUser(UserRepository userRepository, EntityManager em) {
        userRepository.deleteAll();
        UserModel user = createEntity(em);
    ...
    void createUser() throws Exception {
        ...
        assertPersistedUsers(users -> {
            ...
            UserModel testUser = users.get(users.size() - 1);
    ...
    void updateUser() throws Exception {
        ...
        assertPersistedUsers(users -> {
            ...
            UserModel testUser = users.stream().filter(usr -> usr.getId().equals(updatedUser.getId())).findFirst().get();
    ...
    void testUserEquals() throws Exception {
        TestUtil.equalsVerifier(UserModel.class);
    ...
    void testUserToUserDTO() {
        ...
        AdminUserRepresentation userDTO = userMapper.userToAdminUserDTO(user);
    ...
    private void assertPersistedUsers(Consumer<List<UserModel>> userAssertion) {
