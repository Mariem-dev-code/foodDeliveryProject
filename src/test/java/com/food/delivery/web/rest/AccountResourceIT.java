...
import static com.food.delivery.web.rest.AccountResourceIT.TEST_USER_LOGIN;
import static org.assertj.core.api.Assertions.assertThat;
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.*;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.*;

import com.food.delivery.IntegrationTest;
import com.food.delivery.config.Constants;
import com.food.delivery.domain.UserModel;
import com.food.delivery.repository.AuthorityRepository;
import com.food.delivery.repository.UserRepository;
import com.food.delivery.security.AuthoritiesConstants;
import com.food.delivery.service.UserService;
import com.food.delivery.service.dto.AdminUserRepresentation;
import com.food.delivery.service.dto.PasswordChangeDTO;
import com.food.delivery.service.dto.UserRepresentation;
import com.food.delivery.web.rest.vm.KeyAndPasswordVM;
import com.food.delivery.web.rest.vm.ManagedUserVM;
...
class AccountResourceIT {
    ...
    void testGetExistingAccount() throws Exception {
        ...
        AdminUserRepresentation user = new AdminUserRepresentation();
    ...
    void testRegisterInvalidLogin() throws Exception {
        ...
        Optional<UserModel> user = userRepository.findOneByEmailIgnoreCase("funky@example.com");
    ...
    void testRegisterInvalidEmail() throws Exception {
        ...
        Optional<UserModel> user = userRepository.findOneByLogin("bob");
        assertThat(user).isEmpty();
    }
    ...
    void testRegisterDuplicateLogin() throws Exception {
        ...
        Optional<UserModel> testUser = userRepository.findOneByEmailIgnoreCase("alice2@example.com");
    ...
    void testRegisterDuplicateEmail() throws Exception {
        ...
        Optional<UserModel> testUser1 = userRepository.findOneByLogin("test-register-duplicate-email");
        ...
        Optional<UserModel> testUser2 = userRepository.findOneByLogin("test-register-duplicate-email");
        assertThat(testUser2).isEmpty();

        Optional<UserModel> testUser3 = userRepository.findOneByLogin("test-register-duplicate-email-2");
        ...
        Optional<UserModel> testUser4 = userRepository.findOneByLogin("test-register-duplicate-email-3");
        assertThat(testUser4).isPresent();
        assertThat(testUser4.get().getEmail()).isEqualTo("test-register-duplicate-email@example.com");

        testUser4.get().setActivated(true);
        userService.updateUser((new AdminUserRepresentation(testUser4.get())));
    ...
    void testRegisterAdminIsIgnored() throws Exception {
        ...
        Optional<UserModel> userDup = userRepository.findOneWithAuthoritiesByLogin("badguy");
    ...
    void testSaveAccount() throws Exception {
        ...
        AdminUserRepresentation userDTO = new AdminUserRepresentation();
        ...
        UserModel updatedUser = userRepository.findOneWithAuthoritiesByLogin(user.getLogin()).orElse(null);
    ...
    void testSaveExistingEmail() throws Exception {
        ...
        UserModel updatedUser = userRepository.findOneByLogin("save-existing-email").orElse(null);
    ...
    void testSaveExistingEmailAndLogin() throws Exception {
        ...
        UserModel updatedUser = userRepository.findOneByLogin("save-existing-email-and-login").orElse(null);
    ...
    void testChangePasswordWrongExistingPassword() throws Exception {
        ...
        UserModel updatedUser = userRepository.findOneByLogin("change-password-wrong-existing-password").orElse(null);
    ...
    void testChangePassword() throws Exception {
        ...
        UserModel updatedUser = userRepository.findOneByLogin("change-password").orElse(null);
    ...
    void testChangePasswordTooSmall() throws Exception {
        ...
        UserModel updatedUser = userRepository.findOneByLogin("change-password-too-small").orElse(null);
        assertThat(updatedUser.getPassword()).isEqualTo(user.getPassword());
    }
    ...
    void testChangePasswordTooLong() throws Exception {
        ...
        UserModel updatedUser = userRepository.findOneByLogin("change-password-too-long").orElse(null);
        assertThat(updatedUser.getPassword()).isEqualTo(user.getPassword());
    }
    ...
    void testChangePasswordEmpty() throws Exception {
        ...
        UserModel updatedUser = userRepository.findOneByLogin("change-password-empty").orElse(null);
        assertThat(updatedUser.getPassword()).isEqualTo(user.getPassword());
    }
    ...
    void testFinishPasswordReset() throws Exception {
        ...
        UserModel updatedUser = userRepository.findOneByLogin(user.getLogin()).orElse(null);
