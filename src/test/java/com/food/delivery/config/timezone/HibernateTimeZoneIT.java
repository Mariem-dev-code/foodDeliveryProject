package com.food.delivery.config.timezone;

import static java.lang.String.format;
import static org.assertj.core.api.Assertions.assertThat;

import com.food.delivery.IntegrationTest;
import com.food.delivery.repository.timezone.DateTimeWrapper;
import com.food.delivery.repository.timezone.DateTimeWrapperRepository;
import java.time.*;
...
class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM fd_date_time_wrapper where id=%d", fieldName, id);
    }
